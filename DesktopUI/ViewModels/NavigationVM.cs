...
namespace DesktopUI.ViewModels
{
	public class NavigationVM : INotifyPropertyChanged
	{
        ...
        public NavigationVM()
        {
			...
			OpenCompanyMenuCommand = new RelayCommand(CompanyMenu);
			OpenEmployeeCommand = new RelayCommand(Employee);
			AuthView(null);
        }
		//Commands
		...
		public ICommand OpenCompanyMenuCommand { get; set; }
		...
		private void CompanyMenu(object obj)
		{
			CurrentVM = new CompanyVM();
		}
		private void Employee(object obj)
		{
			CurrentVM = new EmployeeVM();
		}
